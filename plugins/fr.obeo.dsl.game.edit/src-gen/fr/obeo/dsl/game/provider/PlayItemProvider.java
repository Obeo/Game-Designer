...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.game.Play} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlayItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Play_sound_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Play_sound_feature", "_UI_Play_type"),
				 GamePackage.Literals.PLAY__SOUND,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_Play_type");
	}

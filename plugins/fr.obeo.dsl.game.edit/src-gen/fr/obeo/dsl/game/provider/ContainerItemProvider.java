...
import fr.obeo.dsl.game.Container;
...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.game.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addShadowColorPropertyDescriptor(object);
		}
	...
	protected void addBorderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_border_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_border_feature", "_UI_Container_type"),
				 GamePackage.Literals.CONTAINER__BORDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addRadiusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_radius_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_radius_feature", "_UI_Container_type"),
				 GamePackage.Literals.CONTAINER__RADIUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addStrokePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_stroke_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_stroke_feature", "_UI_Container_type"),
				 GamePackage.Literals.CONTAINER__STROKE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_width_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_width_feature", "_UI_Container_type"),
				 GamePackage.Literals.CONTAINER__WIDTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_height_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_height_feature", "_UI_Container_type"),
				 GamePackage.Literals.CONTAINER__HEIGHT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addFillPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_fill_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_fill_feature", "_UI_Container_type"),
				 GamePackage.Literals.CONTAINER__FILL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addShadowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_shadow_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_shadow_feature", "_UI_Container_type"),
				 GamePackage.Literals.CONTAINER__SHADOW,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Shadow Color feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addShadowColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_shadowColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_shadowColor_feature", "_UI_Container_type"),
				 GamePackage.Literals.CONTAINER__SHADOW_COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GamePackage.Literals.CONTAINER__WIDGETS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Container_type") + " " + container.getX();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.CONTAINER__WIDGETS,

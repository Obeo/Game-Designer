...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.game.Collision} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollisionItemProvider
	...
	protected void addOrientationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Collision_orientation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Collision_orientation_feature", "_UI_Collision_type"),
				 GamePackage.Literals.COLLISION__ORIENTATION,
				 true,
				 false,
				 false,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Collision_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Collision_source_feature", "_UI_Collision_type"),
				 GamePackage.Literals.COLLISION__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Orientation labelValue = ((Collision)object).getOrientation();

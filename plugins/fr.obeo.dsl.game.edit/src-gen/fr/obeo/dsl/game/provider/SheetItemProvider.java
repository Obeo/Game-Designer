...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.game.Sheet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SheetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GamePackage.Literals.SHEET__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSpritesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sheet_sprites_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sheet_sprites_feature", "_UI_Sheet_type"),
				 GamePackage.Literals.SHEET__SPRITES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GamePackage.Literals.SHEET__ANIMATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.SHEET__ANIMATIONS,
				 GameFactory.eINSTANCE.createAnimation()));
	}

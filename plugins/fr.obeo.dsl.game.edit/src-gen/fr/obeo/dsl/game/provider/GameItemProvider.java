...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.game.Game} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GameItemProvider
	...
	protected void addStagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Game_stage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Game_stage_feature", "_UI_Game_type"),
				 GamePackage.Literals.GAME__STAGE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GamePackage.Literals.GAME__SCENES);
			childrenFeatures.add(GamePackage.Literals.GAME__SPRITES);
			childrenFeatures.add(GamePackage.Literals.GAME__SOUNDS);
			childrenFeatures.add(GamePackage.Literals.GAME__SHEETS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.GAME__SCENES,
				 GameFactory.eINSTANCE.createTMX()));

		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.GAME__SCENES,
				 GameFactory.eINSTANCE.createUI()));

		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.GAME__SPRITES,
				 GameFactory.eINSTANCE.createSprite()));

		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.GAME__SOUNDS,
				 GameFactory.eINSTANCE.createSound()));

		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.GAME__SHEETS,
				 GameFactory.eINSTANCE.createSheet()));
	}

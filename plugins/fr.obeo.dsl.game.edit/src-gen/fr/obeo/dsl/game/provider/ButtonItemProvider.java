...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.game.Button} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ButtonItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addKeyActionNamePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GamePackage.Literals.BUTTON__LABEL,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Key Action Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addKeyActionNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_keyActionName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_keyActionName_feature", "_UI_Button_type"),
				 GamePackage.Literals.BUTTON__KEY_ACTION_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFontPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_font_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_font_feature", "_UI_Button_type"),
				 GamePackage.Literals.BUTTON__FONT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Button)object).getKeyActionName();

...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.game.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GamePackage.Literals.PROPERTY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDisplayPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Property_display_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_display_feature", "_UI_Property_type"),
				 GamePackage.Literals.PROPERTY__DISPLAY,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Property.class)) {
			case GamePackage.PROPERTY__NAME:

 ...
 * <ul>
 *   <li>{@link fr.obeo.dsl.game.impl.MoveEventImpl#getApplyOn <em>Apply On</em>}</li>
 *   <li>{@link fr.obeo.dsl.game.impl.MoveEventImpl#getChangeTo <em>Change To</em>}</li>
 *   <li>{@link fr.obeo.dsl.game.impl.MoveEventImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MoveEventImpl extends MinimalEObjectImpl.Container implements MoveEvent {
	/**
	...
	protected EClass eStaticClass() {
		return GamePackage.Literals.MOVE_EVENT;
	}
	...
	public EList<State> getApplyOn() {
		if (applyOn == null) {
			applyOn = new EObjectWithInverseResolvingEList.ManyInverse<State>(State.class, this, GamePackage.MOVE_EVENT__APPLY_ON, GamePackage.STATE__EVENTS);
		}
		return applyOn;
	}
		...
		if (changeTo != null && changeTo.eIsProxy()) {
			...
			if (changeTo != oldChangeTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GamePackage.MOVE_EVENT__CHANGE_TO, oldChangeTo, changeTo));
			}
		}
		return changeTo;
	}
	...
	public void setChangeTo(State newChangeTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamePackage.MOVE_EVENT__CHANGE_TO, oldChangeTo, changeTo));
	}
	...
	public EList<Action> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentEList<Action>(Action.class, this, GamePackage.MOVE_EVENT__ACTIONS);
		}
		return actions;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GamePackage.MOVE_EVENT__APPLY_ON:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case GamePackage.MOVE_EVENT__ACTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GamePackage.MOVE_EVENT__APPLY_ON:
				return getApplyOn();
			case GamePackage.MOVE_EVENT__CHANGE_TO:
